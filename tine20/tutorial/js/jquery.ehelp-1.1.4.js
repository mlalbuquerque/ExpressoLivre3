    ...
    $.fn.extend({   
		...
		'autolinks':true
            ...
            function doPathAnimation(that, pathvalue){
				...
				if(!$("#EHpointer").length){
					var aoff_top = that.offset().top + 10;
					var aoff_left = that.offset().left + 10;
				}
				else {
					var aoff_top = $("#EHpointer").offset().top;
					var aoff_left = $("#EHpointer").offset().left;
					$("#EHpointer").remove();
				}
                ...
                if(!$.isEmptyObject(pathvalue)) {
                    ...
                    $("#EHpointer").css("top",aoff_top + "px").css("left",aoff_left + "px").fadeIn("fast");
                    ...
                    (function() {
                        ...
                        var pointerx = offset.left + elWidth - 25;//(elWidth/2);
                        var pointery = offset.top + 20;//(elHeight/2);
			   ...
			   if(value.ftriger != "E") {
                            ...
                            switch(tbalign){
                                ...
                                case "LT":
                                    ...
                                    break;
                                case "LB":
                                    topset = (pointery + pointerdim.width);
                                    leftset	= (pointerx - ttipwidth - pointerdim.width);
                                    break;

 ...
 * @subpackage  Frontend
 */
class Tasks_Frontend_WebDAV_Container extends Tinebase_WebDav_Container_Abstract implements Sabre_CalDAV_ICalendar
{
    protected $_applicationName = 'Tasks';
    //Tinebase_Core::getLogger()->debug(__METHOD__ . '::' . __LINE__ .' FLAAAAAAAAA ' );
    ...
    public function getChild($_name)
    {
        ...
        //if ( Tinebase_Application::getInstance()->getApplicationByName('Tasks')->getid() == $this->_container->application_id)
        // {   $this->_application->name = 'Tasks';
        //     $this->_model = 'Task';
        // }
        Tinebase_Core::getLogger()->debug(__METHOD__ . '::' . __LINE__ .' FLAAAAAAAAA aplicacao:' . $this->_application->name . ' modelo:' . $this->_model .' Nome: ' . $_name);
    ...
    {
       Tinebase_Core::getLogger()->debug(__METHOD__ . '::' . __LINE__ .' FLAAAAAAAAA id:' . $this->_container->getId());

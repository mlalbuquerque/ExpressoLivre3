 ...
 * @class       Tine.Felamimail.MATreeLoader
 ...
 * @param       {Object} config
 * @constructor
 * Create a new Tine.Felamimail.MATreeLoader
 * 
 */
Tine.Felamimail.MATreeLoader = Ext.extend(Tine.widgets.tree.Loader, {
            ...
            fstore.asyncQuery('parent_path', path, function(node, callback, scope, data) {
                if (data) {
                    ...
                    data.each(function(folderRecord) {
                        folderRecord.set('id','MA_'+folderRecord.get('id')); 

 ...
 */
Tine.Felamimail.MAFilterPanel = Ext.extend(Tine.widgets.persistentfilter.PickerPanel, {
    filterModel: 'Felamimail_Model_MessageFilter'
});

/**
 * @namespace   Tine.Felamimail
 * @class       Tine.Felamimail.MATreePanel
 ...
 * @param       {Object} config
 * @constructor
 * Create a new Tine.Felamimail.MATreePanel
 * 
 */
Tine.Felamimail.MATreePanel = function(config) {
    ...
    Tine.Felamimail.MATreePanel.superclass.constructor.call(this);
};

Ext.extend(Tine.Felamimail.MATreePanel, Ext.tree.TreePanel, {
...
//        this.folderStore.on('update', this.onUpdateFolderStore, this);
   ...
   /**
    ...
    afterRender: function() {
        Tine.Felamimail.MATreePanel.superclass.afterRender.call(this);
        this.initToolTips();
        this.selectInbox();
     ...
     * render status box
     * 
     * @param {Tine.Felamimail.MATreePanel} tree

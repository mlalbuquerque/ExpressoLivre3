 ...
 * @subpackage  Frontend
 */
class Calendar_Frontend_WebDAV_Task extends Sabre_DAV_File implements Sabre_CalDAV_ICalendarObject, Sabre_DAVACL_IACL
{
    /**
    ...
    public function __construct(Tinebase_Model_Container $_container, $_event = null) 
    {
        ...
        if (! $this->_event instanceof Calendar_Model_Task) {

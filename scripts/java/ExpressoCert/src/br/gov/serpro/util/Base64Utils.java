...
public class Base64Utils {
    ...
    public static String der2pem(byte[] der, boolean isCert){

        int begin = 0;
    	int lineSize = isCert ? 64 : 76;
        int end = lineSize;
    	int bytesWriten = 0;
        ...
        String beginCertificate = "-----BEGIN CERTIFICATE-----" +CRLF;
        String endCertificate = "-----END CERTIFICATE-----" +CRLF;
    ...
    public static String der2pem(byte[] der){
        return Base64Utils.der2pem(der, false);
    }

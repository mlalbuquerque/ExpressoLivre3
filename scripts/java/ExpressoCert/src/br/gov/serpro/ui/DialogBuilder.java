...
//		this.myself = this;
    ...
    // TODO: Lan�ar e implementar exce��o ActionCanceled
    private void cancelButtonActionPerformed() {
        this.setVisible(false);
        this.pin = null; // hack para saber que di�logo foi cancelado.
    ...
    static public String showCertificateSelector(Frame parent, Setup setup, Map<String, String> certificateMap) {
        DialogBuilder certificateSelectorDialog = new DialogBuilder(parent, setup);

        Set<Map.Entry<String, String>> entries = certificateMap.entrySet();
        ...
        for (Map.Entry<String, String> entry : entries){
            ...
            certificateList.add(entry.getValue());
        }
    ...
    private final class EventManager implements ActionListener, KeyListener, WindowListener {
        ...
        public void windowClosed(WindowEvent arg0) {
            //System.out.println("Window Closed: Fechando di�logo!");
        }

        public void windowClosing(WindowEvent arg0) {
            //System.out.println("Window Closing: Fechando di�logo!");
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            if (command.equals("ok")) {
                ...
                // Mostra um aviso de que o campo PIN n�o foi preenchido
                //JOptionPane.showMessageDialog(null, "Campo PIN n�o foi preenchido!",
